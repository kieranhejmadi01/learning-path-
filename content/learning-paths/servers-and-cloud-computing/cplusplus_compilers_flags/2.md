...
In this Learning Path, you will build and run a C++ application on the 1st generation of the Arm AGI CPU running Ubuntu 24.04 LTS. Alternatively, you can AWS Graviton 4 (`r8g.xlarge`) instance running Ubuntu 24.04 LTS. 
